            ...
            case HyperPreamblePhase.Aligning:
            {
                ...
                if (snap != null)
                {
                    ...
                    else
                    {
                        ...
                        var   newOri = QuaternionFromForwardUp(newFwd, _camera.Up);
                        _camera.SetPose(_camera.UniversePosition, newOri);
                        // Mirror orientation to ship so snap.Orientation stays coherent
                        _simulation.TeleportShip(_camera.UniversePosition, newOri);
                    }
                }
                break;
            }
