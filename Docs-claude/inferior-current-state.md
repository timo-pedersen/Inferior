...
0. **Verify `docking-bay` module in-engine** — fly to a Large station and confirm the hollow
   interior actually renders (culling risk), the door/frame look right, and growth still
   extends from its 5 non-door ports. See table above.
